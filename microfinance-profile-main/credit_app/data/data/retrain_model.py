...
class CreditScoringRetrainer:
    ...
    def generate_synthetic_data(self, n_samples=10000):
        ...
        for _ in range(n_samples):
            ...
            employment_status = np.random.choice(['cdi', 'cdd', 'fonctionnaire', 'independant'])
            job_seniority = np.random.randint(0, 240)  # en mois
            monthly_income = np.random.randint(100000, 2000000, step=10000)
            other_income = np.random.randint(0, 200000, step=10000)
            monthly_charges = np.random.randint(50000, monthly_income * 0.6, step=10000)
            existing_debts = np.random.randint(0, 300000, step=10000)
            ...
            if credit_type == 'consommation_generale':
                loan_amount = np.random.randint(100000, min(5000000, monthly_income * 3.5), step=50000)
                loan_duration = np.random.randint(6, 37)
            elif credit_type == 'avance_salaire':
                loan_amount = np.random.randint(50000, min(1000000, monthly_income * 0.7), step=10000)
                loan_duration = 1
            else:  # depannage
                loan_amount = np.random.randint(100000, 2000000, step=50000)
            ...
            if credit_type == 'avance_salaire':
                salary_domiciliation = np.random.choice([True, False], p=[0.8, 0.2])
                employer_convention = np.random.choice([True, False], p=[0.7, 0.3])
                ...
                cash_flow_status = np.random.choice(['positif', 'equilibre', 'temporairement_negatif', 'negatif'])
